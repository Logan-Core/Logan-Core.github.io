(() => {
    ...
    var Xe = class {
        ...
        m(e, t, s = null) {
            this.e || (this.is_svg ? this.e = us(t.nodeName) : this.e = k(t.nodeType === 11 ? "TEMPLATE" : t.nodeName), this.t = t.tagName !== "TEMPLATE" ? t : t.content, this.c(e)), this.i(s)
        }
        h(e) {
    ...
    function ln(n, e, t, s, r, l, i, a, o, h, _, f) {
        ...
        for (; c && E;) {
            let F = d[E - 1],
                ...
                P = F.key,
                Z = U.key;
            F === U ? (_ = F.first, c--, E--) : R.has(Z) ? !i.has(P) || w.has(P) ? X(F) : B.has(Z) ? c-- : T.get(P) > T.get(Z) ? (B.add(P), X(F)) : (w.add(Z), c--) : (o(U, i), c--)
        }
        for (; c--;) {
            let F = n[c];
            R.has(F.key) || o(F, i)
    ...
    var ms = ["allowfullscreen", "allowpaymentrequest", "async", "autofocus", "autoplay", "checked", "controls", "default", "defer", "disabled", "formnovalidate", "hidden", "inert", "ismap", "loop", "multiple", "muted", "nomodule", "novalidate", "open", "playsinline", "readonly", "required", "reversed", "selected"],
        Fi = new Set([...ms]);
    ...
    function J(n, e, t, s, r, l, i, a = [-1]) {
        ...
        if (h.ctx = t ? t(n, e.props || {}, (f, c, ...E) => {
            ...
            }) : [], h.update(), _ = !0, V(h.before_update), h.fragment = s ? s(h.ctx) : !1, e.target) {
            if (e.hydrate) {
                as();
                let f = cs(e.target);
    ...
    function Qe(n, e = {}) {
        ...
        if (Es.call(ut, r)) {
            let a = ut[r];
            return (e.normalize === void 0 || e.normalize === null || e.normalize) && typeof a == "string" ? Qe(a) : (t[on.includes(r) ? "regular" : "irregular"] = s, t)
        }
    ...
    function bs(n) {
        let e, t, s, r, l, i = n[0] && _n(n);
        return {
            c() {
                i && i.c(), e = M(), t = k("div"), s = k("p"), s.textContent = `${n[3](30)}`, r = M(), l = k("p"), l.textContent = `${n[3](40)}`, p(s, "class", "pagefind-ui__result-title pagefind-ui__loading svelte-j9e30"), p(l, "class", "pagefind-ui__result-excerpt pagefind-ui__loading svelte-j9e30"), p(t, "class", "pagefind-ui__result-inner svelte-j9e30")
            },
            m(a, o) {
    ...
    function Rs(n) {
        let e, t, s, r, l = n[1].meta?.title + "",
            i, a, o, h, _ = n[1].excerpt + "",
            f, c = n[0] && fn(n),
            E = n[2].length && hn(n);
        return {
            c() {
                c && c.c(), e = M(), t = k("div"), s = k("p"), r = k("a"), i = A(l), o = M(), h = k("p"), f = M(), E && E.c(), p(r, "class", "pagefind-ui__result-link svelte-j9e30"), p(r, "href", a = n[1].meta?.url || n[1].url), p(s, "class", "pagefind-ui__result-title svelte-j9e30"), p(h, "class", "pagefind-ui__result-excerpt svelte-j9e30"), p(t, "class", "pagefind-ui__result-inner svelte-j9e30")
            },
            m(u, m) {
                c && c.m(u, m), y(u, e, m), y(u, t, m), b(t, s), b(s, r), b(r, i), b(t, o), b(t, h), h.innerHTML = _, b(t, f), E && E.m(t, null)
            },
            p(u, m) {
                u[0] ? c ? c.p(u, m) : (c = fn(u), c.c(), c.m(e.parentNode, e)) : c && (c.d(1), c = null), m & 2 && l !== (l = u[1].meta?.title + "") && N(i, l), m & 2 && a !== (a = u[1].meta?.url || u[1].url) && p(r, "href", a), m & 2 && _ !== (_ = u[1].excerpt + "") && (h.innerHTML = _), u[2].length ? E ? E.p(u, m) : (E = hn(u), E.c(), E.m(t, null)) : E && (E.d(1), E = null)
            },
            d(u) {
    ...
    function dn(n) {
        ...
        return {
            c() {
                e = k("img"), p(e, "class", "pagefind-ui__result-image svelte-j9e30"), le(e.src, t = n[1].meta?.image) || p(e, "src", t), p(e, "alt", s = n[1].meta?.image_alt || n[1].meta?.title)
            },
            m(r, l) {
                y(r, e, l)
            },
    ...
    function ks(n, e, t) {
        let {
            ...
            process_result: r = null
        } = e, {
            result: l = {
                data: async () => {}
            }
        } = e, i = ["title", "image", "image_alt", "url"], a, o = [], h = async f => {
    ...
    function Cs(n) {
        let e, t, s, r, l, i = n[0] && Rn(n);
        return {
            c() {
                i && i.c(), e = M(), t = k("div"), s = k("p"), s.textContent = `${n[5](30)}`, r = M(), l = k("p"), l.textContent = `${n[5](40)}`, p(s, "class", "pagefind-ui__result-title pagefind-ui__loading svelte-4xnkmf"), p(l, "class", "pagefind-ui__result-excerpt pagefind-ui__loading svelte-4xnkmf"), p(t, "class", "pagefind-ui__result-inner svelte-4xnkmf")
            },
            m(a, o) {
                i && i.m(a, o), y(a, e, o), y(a, t, o), b(t, s), b(t, r), b(t, l)
            },
    ...
    function ys(n) {
        ...
        return {
            c() {
                ...
                _ = M(), m && m.c(), p(r, "class", "pagefind-ui__result-link svelte-4xnkmf"), p(r, "href", a = n[1].meta?.url || n[1].url), p(s, "class", "pagefind-ui__result-title svelte-4xnkmf"), p(t, "class", "pagefind-ui__result-inner svelte-4xnkmf")
            },
            m(d, R) {
            ...
            p(d, R) {
                if (d[0] ? f ? f.p(d, R) : (f = Tn(d), f.c(), f.m(e.parentNode, e)) : f && (f.d(1), f = null), R & 2 && l !== (l = d[1].meta?.title + "") && N(i, l), R & 2 && a !== (a = d[1].meta?.url || d[1].url) && p(r, "href", a), d[4] ? c ? c.p(d, R) : (c = Cn(d), c.c(), c.m(t, h)) : c && (c.d(1), c = null), R & 8) {
                    E = d[3];
                    let T;
    ...
    function kn(n) {
        ...
        return {
            c() {
                e = k("img"), p(e, "class", "pagefind-ui__result-image svelte-4xnkmf"), le(e.src, t = n[1].meta?.image) || p(e, "src", t), p(e, "alt", s = n[1].meta?.image_alt || n[1].meta?.title)
            },
            m(r, l) {
                y(r, e, l)
            },
    ...
    function yn(n) {
        let e, t, s, r = n[15].title + "",
            l, i, a, o, h = n[15].excerpt + "";
        return {
            c() {
                e = k("div"), t = k("p"), s = k("a"), l = A(r), a = M(), o = k("p"), p(s, "class", "pagefind-ui__result-link svelte-4xnkmf"), p(s, "href", i = n[15].url), p(t, "class", "pagefind-ui__result-title svelte-4xnkmf"), p(o, "class", "pagefind-ui__result-excerpt svelte-4xnkmf"), p(e, "class", "pagefind-ui__result-nested svelte-4xnkmf")
            },
            m(_, f) {
                y(_, e, f), b(e, t), b(t, s), b(s, l), b(e, a), b(e, o), o.innerHTML = h
            },
            p(_, f) {
                f & 8 && r !== (r = _[15].title + "") && N(l, r), f & 8 && i !== (i = _[15].url) && p(s, "href", i), f & 8 && h !== (h = _[15].excerpt + "") && (o.innerHTML = h)
            },
            d(_) {
                _ && C(e)
            }
    ...
    function vs(n, e, t) {
        ...
        } = e, i = ["title", "image", "image_alt", "url"], a, o = [], h = [], _ = !1, f = (u, m) => {
            if (u.length <= m) return u;
            let d = [...u].sort((R, T) => T.locations.length - R.locations.length).slice(0, 3).map(R => R.url);
            return u.filter(R => d.includes(R.url))
        }, c = async u => {
            t(1, a = await u.data()), t(1, a = r?.(a) ?? a), t(2, o = Object.entries(a.meta).filter(([m]) => !i.includes(m))), Array.isArray(a.sub_results) && (t(4, _ = a.sub_results?.[0]?.url === (a.meta?.url || a.url)), _ ? t(3, h = f(a.sub_results.slice(1), 3)) : t(3, h = f([...a.sub_results], 3)))
    ...
    function Hn(n) {
        let e, t, s = n[3]("filters_label", n[4], n[5]) + "",
            r, l, i = Object.entries(n[1]),
            a = [];
    ...
    function Nn(n) {
        ...
        return {
            c() {
                e = k("div"), t = k("input"), i = M(), a = k("label"), o = new Xe(!1), _ = A(" ("), c = A(f), E = A(")"), m = M(), p(t, "class", "pagefind-ui__filter-checkbox svelte-1v2r7ls"), p(t, "type", "checkbox"), p(t, "id", s = n[9] + "-" + n[13]), p(t, "name", r = n[9]), t.__value = l = n[13], t.value = t.__value, o.a = _, p(a, "class", "pagefind-ui__filter-label svelte-1v2r7ls"), p(a, "for", u = n[9] + "-" + n[13]), p(e, "class", "pagefind-ui__filter-value svelte-1v2r7ls"), W(e, "pagefind-ui__filter-value--checked", n[0][`${n[9]}:${n[13]}`])
            },
            m(S, w) {
                y(S, e, w), b(e, t), t.checked = n[0][`${n[9]}:${n[13]}`], b(e, i), b(e, a), o.m(h, a), b(a, _), b(a, c), b(a, E), b(e, m), d || (R = K(t, "change", T), d = !0)
            },
            p(S, w) {
                n = S, w & 2 && s !== (s = n[9] + "-" + n[13]) && p(t, "id", s), w & 2 && r !== (r = n[9]) && p(t, "name", r), w & 2 && l !== (l = n[13]) && (t.__value = l, t.value = t.__value), w & 3 && (t.checked = n[0][`${n[9]}:${n[13]}`]), w & 2 && h !== (h = n[13] + "") && o.p(h), w & 2 && f !== (f = n[14] + "") && N(c, f), w & 2 && u !== (u = n[9] + "-" + n[13]) && p(a, "for", u), w & 3 && W(e, "pagefind-ui__filter-value--checked", n[0][`${n[9]}:${n[13]}`])
            },
            d(S) {
                S && C(e), d = !1, R()
            }
    ...
    function On(n) {
        let e, t = (n[2] || n[14] || n[0][`${n[9]}:${n[13]}`]) && Nn(n);
        return {
            c() {
                t && t.c(), e = x()
            },
    ...
    function jn(n) {
        let e, t, s = n[9].replace(/^(\w)/, zn) + "",
            r, l, i, a = n[9] + "",
            o, h, _ = Object.entries(n[10] || {}),
            f = [];
        ...
        return {
            c() {
                ...
                h = M(), p(t, "class", "pagefind-ui__filter-name svelte-1v2r7ls"), p(i, "class", "pagefind-ui__filter-group-label svelte-1v2r7ls"), p(l, "class", "pagefind-ui__filter-group svelte-1v2r7ls"), p(e, "class", "pagefind-ui__filter-block svelte-1v2r7ls"), e.open = n[6]
            },
            m(c, E) {
    ...
    function As(n, e, t) {
        let {
            available_filters: s = null
        } = e, {
            show_empty_filters: r = !0
        } = e, {
            translate: l = () => ""
        } = e, {
        ...
        return n.$$set = c => {
            "available_filters" in c && t(1, s = c.available_filters), "show_empty_filters" in c && t(2, r = c.show_empty_filters), "translate" in c && t(3, l = c.translate), "automatic_translations" in c && t(4, i = c.automatic_translations), "translations" in c && t(5, a = c.translations)
        }, n.$$.update = () => {
            if (n.$$.dirty & 130) {
                e: if (s && !h) {
                    t(7, h = !0);
    ...
    var gi = [dt, ht, mt, pt, gt, Et, bt, Rt, Tt, kt, Ct, yt, St, vt, Mt, At, wt, Ft, Ht, Nt, Ot, jt, zt, Dt, Ut, It, Pt, Lt, qt, Bt],
        Un = gi,
        In = ["../../translations/af.json", "../../translations/bn.json", "../../translations/ca.json", "../../translations/da.json", "../../translations/de.json", "../../translations/en.json", "../../translations/es.json", "../../translations/fi.json", "../../translations/fr.json", "../../translations/gl.json", "../../translations/hi.json", "../../translations/hr.json", "../../translations/hu.json", "../../translations/id.json", "../../translations/it.json", "../../translations/ja.json", "../../translations/mi.json", "../../translations/nl.json", "../../translations/no.json", "../../translations/pl.json", "../../translations/pt.json", "../../translations/ru.json", "../../translations/sr.json", "../../translations/sv.json", "../../translations/ta.json", "../../translations/tr.json", "../../translations/vi.json", "../../translations/zh-cn.json", "../../translations/zh-tw.json", "../../translations/zh.json"];
    ...
    function Ln(n) {
        ...
        return n[7] !== void 0 && (l.selected_filters = n[7]), e = new Dn({
            props: l
            ...
            p(i, a) {
                let o = {};
                a[0] & 16 && (o.show_empty_filters = i[4]), a[0] & 65536 && (o.available_filters = i[16]), a[0] & 131072 && (o.automatic_translations = i[17]), a[0] & 32 && (o.translations = i[5]), !t && a[0] & 128 && (t = !0, o.selected_filters = i[7], nn(() => t = !1)), e.$set(o)
            },
            i(i) {
    ...
    function qn(n) {
        ...
        return t = a(n, [-1, -1]), s = i[t] = l[t](n), {
            ...
            p(o, h) {
                let _ = t;
                t = a(o, h), t === _ ? i[t].p(o, h) : (ie(), I(i[_], 1, 1, () => {
                    i[_] = null
                }), ae(), s = i[t], s ? s.p(o, h) : (s = i[t] = l[t](o), s.c()), z(s, 1), s.m(e, null))
            },
            i(o) {
                r || (z(s), r = !0)
            },
    ...
    function bi(n) {
        ...
        return {
            ...
            p(m, d) {
                _ === (_ = h(m, d)) && f ? f.p(m, d) : (f.d(1), f = _(m), f && (f.c(), f.m(e, null))), d[0] & 34830 && (c = m[11].results.slice(0, m[15]), ie(), r = ln(r, d, E, 1, m, c, l, s, rn, Bn, null, Pn), ae()), m[11].results.length > m[15] ? u ? u.p(m, d) : (u = Wn(m), u.c(), u.m(a.parentNode, a)) : u && (u.d(1), u = null)
            },
            i(m) {
                if (!o) {
    ...
    function Ti(n) {
        let e = n[18]("many_results", n[17], n[5]).replace(/\[SEARCH_TERM\]/, n[14]).replace(/\[COUNT\]/, new Intl.NumberFormat(n[5].language).format(n[11].results.length)) + "",
            t;
        return {
            c() {
                t = A(e)
            ...
            p(s, r) {
                r[0] & 149536 && e !== (e = s[18]("many_results", s[17], s[5]).replace(/\[SEARCH_TERM\]/, s[14]).replace(/\[COUNT\]/, new Intl.NumberFormat(s[5].language).format(s[11].results.length)) + "") && N(t, e)
            },
            d(s) {
                s && C(t)
            }
    ...
    function ki(n) {
        let e = n[18]("one_result", n[17], n[5]).replace(/\[SEARCH_TERM\]/, n[14]).replace(/\[COUNT\]/, new Intl.NumberFormat(n[5].language).format(1)) + "",
            t;
        return {
            c() {
                t = A(e)
            ...
            p(s, r) {
                r[0] & 147488 && e !== (e = s[18]("one_result", s[17], s[5]).replace(/\[SEARCH_TERM\]/, s[14]).replace(/\[COUNT\]/, new Intl.NumberFormat(s[5].language).format(1)) + "") && N(t, e)
            },
            d(s) {
                s && C(t)
            }
    ...
    function Bn(n, e) {
        let t, s, r, l, i, a = [Si, yi],
            o = [];

        function h(_, f) {
            return _[2] ? 0 : 1
        }
        return s = h(e, [-1, -1]), r = o[s] = a[s](e), {
            key: n,
            first: null,
            c() {
            ...
            p(_, f) {
                e = _;
                let c = s;
                s = h(e, f), s === c ? o[s].p(e, f) : (ie(), I(o[c], 1, 1, () => {
                    o[c] = null
                }), ae(), r = o[s], r ? r.p(e, f) : (r = o[s] = a[s](e), r.c()), z(r, 1), r.m(l.parentNode, l))
            },
            i(_) {
                i || (z(r), i = !0)
            },
    ...
    function Wn(n) {
        let e, t = n[18]("load_more", n[17], n[5]) + "",
            s, r, l;
        return {
            c() {
    ...
    function Vn(n) {
        let e, t = n[18]("searching", n[17], n[5]).replace(/\[SEARCH_TERM\]/, n[14]) + "",
            s;
        return {
            c() {
    ...
    function vi(n) {
        let e, t, s, r, l, i, a = n[18]("clear_search", n[17], n[5]) + "",
            o, h, _, f, c, E, u, m, d = n[10] && Ln(n),
            R = n[13] && qn(n);
        return {
            c() {
                e = k("div"), t = k("form"), s = k("input"), l = M(), i = k("button"), o = A(a), h = M(), _ = k("div"), d && d.c(), f = M(), R && R.c(), p(s, "class", "pagefind-ui__search-input svelte-e9gkc3"), p(s, "type", "text"), p(s, "placeholder", r = n[18]("placeholder", n[17], n[5])), p(s, "autocapitalize", "none"), p(s, "enterkeyhint", "search"), p(i, "class", "pagefind-ui__search-clear svelte-e9gkc3"), W(i, "pagefind-ui__suppressed", !n[6]), p(_, "class", "pagefind-ui__drawer svelte-e9gkc3"), W(_, "pagefind-ui__hidden", !n[13]), p(t, "class", "pagefind-ui__form svelte-e9gkc3"), p(t, "role", "search"), p(t, "aria-label", c = n[18]("search_label", n[17], n[5])), p(t, "action", "javascript:void(0);"), p(e, "class", "pagefind-ui svelte-e9gkc3"), W(e, "pagefind-ui--reset", n[0])
            },
            m(T, S) {
                y(T, e, S), b(e, t), b(t, s), it(s, n[6]), n[31](s), b(t, l), b(t, i), b(i, o), n[32](i), b(t, h), b(t, _), d && d.m(_, null), b(_, f), R && R.m(_, null), E = !0, u || (m = [K(s, "focus", n[19]), K(s, "keydown", n[29]), K(s, "input", n[30]), K(i, "click", n[33]), K(t, "submit", Mi)], u = !0)
            },
            p(T, S) {
                (!E || S[0] & 131104 && r !== (r = T[18]("placeholder", T[17], T[5]))) && p(s, "placeholder", r), S[0] & 64 && s.value !== T[6] && it(s, T[6]), (!E || S[0] & 131104) && a !== (a = T[18]("clear_search", T[17], T[5]) + "") && N(o, a), (!E || S[0] & 64) && W(i, "pagefind-ui__suppressed", !T[6]), T[10] ? d ? (d.p(T, S), S[0] & 1024 && z(d, 1)) : (d = Ln(T), d.c(), z(d, 1), d.m(_, f)) : d && (ie(), I(d, 1, 1, () => {
                    d = null
                }), ae()), T[13] ? R ? (R.p(T, S), S[0] & 8192 && z(R, 1)) : (R = qn(T), R.c(), z(R, 1), R.m(_, null)) : R && (ie(), I(R, 1, 1, () => {
                    R = null
                }), ae()), (!E || S[0] & 8192) && W(_, "pagefind-ui__hidden", !T[13]), (!E || S[0] & 131104 && c !== (c = T[18]("search_label", T[17], T[5]))) && p(t, "aria-label", c), (!E || S[0] & 1) && W(e, "pagefind-ui--reset", T[0])
            },
            i(T) {
                E || (z(d), z(R), E = !0)
            },
    ...
    function Ai(n, e, t) {
        ...
        for (let g = 0; g < r.length; g++) s[r[g]] = {
            language: r[g],
            ...Un[g].strings
        };
        let {
            base_path: l = "/pagefind/"
        } = e, {
            page_size: i = 5
        } = e, {
            reset_styles: a = !0
            ...
            show_sub_results: h = !1
        } = e, {
            excerpt_length: _
        } = e, {
            process_result: f = null
        } = e, {
            process_term: c = null
        } = e, {
            show_empty_filters: E = !0
        } = e, {
            debounce_timeout_ms: u = 300
        } = e, {
            pagefind_options: m = {}
        } = e, {
            merge_index: d = []
        } = e, {
            trigger_search_term: R = ""
        } = e, {
            translations: T = {}
        } = e, S = "", w, B, X, F = 40, U = !1, P = [], Z = !1, $e = !1, Gt = 0, Kt = "", et = i, Jt = null, ue = null, Ge = {}, Yt = s.en, Kn = (g, H, O) => O[g] ?? H[g] ?? "";
        at(() => {
        ...
        let Xt = async () => {
            if (!U && (t(10, U = !0), !w)) {
                ...
                try {
                    ...
                    console.error(O), console.error([`Pagefind couldn't be loaded from ${this.options.bundlePath}pagefind.js`, "You can configure this by passing a bundlePath option to PagefindUI", `[DEBUG: Loaded from ${document?.currentScript?.src??"no known script location"}]`].join(`
`))
                }
                _ || t(22, _ = h ? 12 : 30);
                let H = {
            ...
            let O = Yn(H),
                L = () => Zn(g, O);
            u > 0 && g ? (ce && clearTimeout(ce), ce = setTimeout(L, u), await Zt(), w.preload(g, {
                filters: O
            })) : L(), Qn()
        }, Zt = async () => {
    ...
    var xe = class {
        constructor(e) {
            ...
            let t = e.element ?? "[data-pagefind-ui]",
                ...
                E = e.mergeIndex ?? [],
                u = e.translations ?? [];
            delete e.element, delete e.bundlePath, delete e.pageSize, delete e.resetStyles, delete e.showImages, delete e.showSubResults, delete e.excerptLength, delete e.processResult, delete e.processTerm, delete e.showEmptyFilters, delete e.debounceTimeoutMs, delete e.mergeIndex, delete e.translations;
